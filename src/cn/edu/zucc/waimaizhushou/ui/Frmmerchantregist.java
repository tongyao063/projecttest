...
public class Frmmerchantregist extends JDialog implements ActionListener {
	...
	public Frmmerchantregist(Frame f, String s, boolean b) {
		super(f, s, b);
		toolBar.setLayout(new FlowLayout(FlowLayout.RIGHT));
		toolBar.add(this.btnOk);
		toolBar.add(btnCancel);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel)
			...
			try {
				BeanUser user=WaiMaiUtil.userManager.reg(userid,pwd1,pwd2);
				this.setVisible(false);
