...
public class Frmadministratorregist extends JDialog implements ActionListener {
	...
	public Frmadministratorregist(Dialog f, String s, boolean b) {
		super(f, s, b);
	...
	public Frmadministratorregist(Frame f, String s, boolean b) {
		super(f, s, b);
		toolBar.setLayout(new FlowLayout(FlowLayout.RIGHT));
		toolBar.add(this.btnOk);
		toolBar.add(btnCancel);
