...
public class Frmmerchantlogin extends JDialog implements ActionListener {
	private JPanel toolBar = new JPanel();
	private JPanel workPane = new JPanel();
	private JButton btnLogin = new JButton("商家登陆");
	private JButton btnCancel = new JButton("退出");
	private JButton btnRegister = new JButton("商家注册");
		
	private JLabel labelUser = new JLabel("商家名称：");
